/*
    ...
    - score system (DONE)
    - make the snake appear on the opposite side when hitting the border (DONE)
    - make the snake faster after certain point limit?
    - save hiscore locally
    - UI?
...
function placeFood() {
    ...
    for (const trail of snake) { // if the food is placed on the snake, don't.
